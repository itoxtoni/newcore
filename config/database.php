    ...
    */
    ...
    'connections' => [
        ...
        'wink' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_WINK_HOST', '127.0.0.1'),
            'port' => env('DB_WINK_PORT', '3306'),
            'database' => env('DB_WINK_DATABASE', 'forge'),
            'username' => env('DB_WINK_USERNAME', 'forge'),
            'password' => env('DB_WINK_PASSWORD', ''),
            'unix_socket' => env('DB_WINK_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
