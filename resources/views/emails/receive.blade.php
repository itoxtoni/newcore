                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ env('APP_URL') }}"
                                ...
                                <img src="{{ env('APP_LOGO') ? url('storage/' . env('APP_LOGO')) : url('assets/media/image/logo.png') }}" class="logo"
                                    alt="Laravel Logo"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            You're receiving this email because we received your registration.</p>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            {!! QrCode::getBarcodeHTML($user->bib, 'QRCODE', 7, 7) !!}
                                        ...
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; border-top: 1px solid #e8e5ef; margin-top: 25px; padding-top: 25px;">
                                            ...
                                            <tr style="padding: 10px 15px;margin-bottom:10px">
                                                <td  style="text-align: left;width:35%">{{ $relation->name ?? '' }}</td>
                                                <td  style="text-align: left;width:20%">{{ $relation->relationship ?? '' }}</td>
                                        ...
                                        <p
                                        style="box-sizing: border-box; padding-top:20px;border-top: 1px solid #e8e5ef;  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: right;">
                                        Regards,<br>
                                        <br>
                                        Admin {{ config('app.name') }}</p>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        If you're having trouble, please contact administrator at {{ env('APP_PHONE') }}
                                                    </p>
