            ...
            <div class="minicar-body">
                ...
                <ul class="cart_list">
                    <li class="mini_cart_item">
                        <div class="image">
                            <a href="#">
                                <img src="{{ asset('zunzo/images/product/pd1.jpg') }}"
                                    alt="image">
                            </a>
                        </div>
                        <div class="title">
                    ...
                    <li class="mini_cart_item">
                        <div class="image">
                            <a href="#">
                                <img src="{{ asset('zunzo/images/product/pd4.jpg') }}"
                                    alt="image">
                            </a>
                        </div>
                        <div class="title">
                    ...
                    <li class="mini_cart_item">
                        <div class="image">
                            <a href="#">
                                <img src="{{ asset('zunzo/images/product/pd2.jpg') }}"
                                    alt="image">
                            </a>
                        </div>
                        <div class="title">
                    ...
                    <li class="mini_cart_item">
                        <div class="image">
                            <a href="#">
                                <img src="{{ asset('zunzo/images/product/pd3.jpg') }}"
                                    alt="image">
                            </a>
                        </div>
                        <div class="title">
